...
export const config = {
  ...
  // Transactional email (Resend), used only to verify a new sign-in address.
  // The default sender is Resend's shared sandbox domain, which works with no
  // DNS setup but ONLY delivers to your own Resend account address — set
  // EMAIL_FROM to an address on a domain you've verified to reach anyone else.
